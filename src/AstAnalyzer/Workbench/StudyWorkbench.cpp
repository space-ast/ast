...
namespace
{
    class StudyWorkbenchSymbolScope : public ISymbolScope
    {
    public:
        StudyWorkbenchSymbolScope(StudyWorkbench* analyzer)
            : analyzer_(analyzer)
        {}
...
StudyWorkbench::StudyWorkbench()
    : interpreter_(aNewInterpreter(new StudyWorkbenchSymbolScope(this)))
{
    
}

errc_t StudyWorkbench::execute()
{
