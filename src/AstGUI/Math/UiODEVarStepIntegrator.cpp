...
void UiODEVarStepIntegrator::setupUi()
{
    ...
    initialStepLabel_ = new QLabel(tr(u8"初始步长:"), this);
    ...
    initialStepUnit_ = new QLabel(tr(u8"秒"), this);
    ...
    // 步长控制
    stepSizeGroup_ = new QGroupBox(tr(u8"步长控制"), this);
    ...
    maxStepLabel_ = new QLabel(tr(u8"最大步长:"), this);
    ...
    maxStepUnit_ = new QLabel(tr(u8"秒"), this);
    ...
    errorControlLabel_ = new QLabel(tr(u8"误差控制:"), this);
    errorControlCombo_ = new QComboBox(this);
    errorControlCombo_->addItem(tr(u8"按分量相对误差"));
    errorControlCombo_->addItem(tr(u8"按分量绝对误差"));
    ...
    maxAbsErrorLabel_ = new QLabel(tr(u8"最大绝对误差:"), this);
    ...
    maxRelErrorLabel_ = new QLabel(tr(u8"最大相对误差:"), this);
    ...
    maxIterationsLabel_ = new QLabel(tr(u8"最大迭代次数:"), this);
    ...
    highSafetyLabel_ = new QLabel(tr(u8"高安全系数:"), this);
    ...
    lowSafetyLabel_ = new QLabel(tr(u8"低安全系数:"), this);
