...
void UiGravityForce::setupUi()
{
    ...
    degreeLabel_ = new QLabel(tr(u8"阶数:"), this);
    ...
    orderLabel_ = new QLabel(tr(u8"次数:"), this);
    ...
    secularVariationsCheck_ = new QCheckBox(tr(u8"包含引力场长期变化"), this);
    ...
    // 固体潮汐配置
    solidTidesGroup_ = new QGroupBox(tr(u8"固体潮汐"), this);
    solidTidesLayout_ = new QGridLayout(solidTidesGroup_);
    
    solidTideTypeLayout_ = new QHBoxLayout();
    solidTideTypeLabel_ = new QLabel(tr(u8"类型:"), this);
    ...
    timeDependentCheck_ = new QCheckBox(tr(u8"包含时间依赖项"), this);
    ...
    minAmplitudeLabel_ = new QLabel(tr(u8"最小振幅:"), this);
    ...
    degreeOceanLabel_ = new QLabel(tr(u8"阶数:"), this);
    ...
    orderOceanLabel_ = new QLabel(tr(u8"次数:"), this);
    ...
    minAmplitudeOceanLabel_ = new QLabel(tr(u8"最小振幅:"), this);
...
void UiGravityForce::refreshModel()
{
    ...
    modelCombo_->addItem(tr(u8"自定义文件"));
}

void UiGravityForce::refreshSolidTideType()
{
    solidTideTypeCombo_->clear();
    solidTideTypeCombo_->addItem(tr(u8"无"));
    solidTideTypeCombo_->addItem(tr(u8"仅永久潮汐"));
    solidTideTypeCombo_->addItem(tr(u8"完整潮汐"));
}
