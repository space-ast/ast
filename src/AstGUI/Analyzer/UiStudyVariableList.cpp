...
UiStudyVariableList::UiStudyVariableList(QWidget* parent)
    : QWidget(parent)
{
    setupUi();
}

void UiStudyVariableList::setupUi()
{
    ...
    connect(listWidget_, &QListWidget::currentItemChanged,
            this, &UiStudyVariableList::onSelectionChanged);
...
void UiStudyVariableList::onSelectionChanged()
{
