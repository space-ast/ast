    ...
    : UiObject(parent)
{
    ...
    // ============ 基本信息组 ============
    QGroupBox* basicGroup = new QGroupBox(tr(u8"基本信息"), this);
    QGridLayout* basicLayout = new QGridLayout(basicGroup);
    
    // 名称
    basicLayout->addWidget(new QLabel(tr(u8"名称"), this), 0, 0);
    ...
    // ============ 引力模型组 ============
    QGroupBox* gravityGroup = new QGroupBox(tr(u8"引力模型"), this);
    ...
    // ============ 形状组 ============
    QGroupBox* shapeGroup = new QGroupBox(tr(u8"形状"), this);
    QGridLayout* shapeLayout = new QGridLayout(shapeGroup);
    
    // 形状类型
    shapeLayout->addWidget(new QLabel(tr(u8"类型"), this), 0, 0);
    ...
    // 半长轴
    shapeLayout->addWidget(new QLabel(tr(u8"半长轴"), this), 1, 0);
    ...
    // 半中轴
    shapeLayout->addWidget(new QLabel(tr(u8"半中轴"), this), 2, 0);
    ...
    // 半短轴
    shapeLayout->addWidget(new QLabel(tr(u8"半短轴"), this), 3, 0);
    ...
    // ============ 姿态组 ============
    QGroupBox* orientationGroup = new QGroupBox(tr(u8"姿态"), this);
    ...
    // ============ 星历组 ============
    QGroupBox* ephemerisGroup = new QGroupBox(tr(u8"星历"), this);
    QGridLayout* ephemerisLayout = new QGridLayout(ephemerisGroup);
    
    // 星历类型
    ephemerisLayout->addWidget(new QLabel(tr(u8"类型"), this), 0, 0);
...
{
    QMessageBox::information(this, tr(u8"引力模型详情"), tr(u8"引力模型配置对话框（待实现）"));
}

void UiCelestialBody::onOrientationDetails()
{
    QMessageBox::information(this, tr(u8"姿态详情"), tr(u8"姿态配置对话框（待实现）"));
}
