///
/// @file      TimePointRange.hpp
/// @brief     按步长采样的时间点范围
/// @details   对 [start, stop] 闭区间按 step 步长采样的惰性可迭代范围。
/// @author    axel
/// @date      2026-08-24
...
public:
    ...
    public:
        ...
        using reference         = TimePoint;   // input iterator：按值返回

        iterator() = default;
        iterator(const TimePointRange* range, size_t idx)
    ...
    private:
        const TimePointRange* range_ = nullptr;
        size_t idx_ = 0;
    };
