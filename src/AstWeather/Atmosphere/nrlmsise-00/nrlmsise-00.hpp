...
namespace ast
{
	...
	protected:
		...
		/* ------------------------------- SCALH ----------------------------- */
		/* ------------------------------------------------------------------- */
		inline double scalh(double alt, double xm, double temp)
		{
			double g;
			double rgas = 831.4;
		...
		;
		double  globe7(NRLMSISE00_CONST double* p, struct nrlmsise_input* input, struct nrlmsise_flags* flags)
		;
		double  glob7s(NRLMSISE00_CONST double* p, struct nrlmsise_input* input, struct nrlmsise_flags* flags)
		;
