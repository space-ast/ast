...
#include "UiSequenceWorkbench.hpp"
...
UiSequenceWorkbench::UiSequenceWorkbench(QWidget* parent)
    : UiSequenceWorkbench(nullptr, parent)
{
}

UiSequenceWorkbench::UiSequenceWorkbench(Object* sequence, QWidget* parent)
...
void UiSequenceWorkbench::setupUi()
{
...
void UiSequenceWorkbench::setupToolBar()
{
    ...
    addMenu_->addAction(missionIcon("InitialState"),       tr("初始状态 (InitialState)"),  this, &UiSequenceWorkbench::onAddInitialState);
    addMenu_->addAction(missionIcon("Propagate"),          tr("轨道预报 (Propagate)"),    this, &UiSequenceWorkbench::onAddPropagate);
    addMenu_->addAction(missionIcon("Maneuver"),           tr("机动 (Maneuver)"),         this, &UiSequenceWorkbench::onAddManeuver);
    addMenu_->addAction(missionIcon("Sequence"),           tr("序列 (Sequence)"),         this, &UiSequenceWorkbench::onAddSequence);
    addMenu_->addAction(missionIcon("TargeterSequence"),   tr("打靶序列 (TargeterSeq)"),  this, &UiSequenceWorkbench::onAddTargeterSequence);
    addMenu_->addSeparator();
    addMenu_->addAction(missionIcon("LandingSite"),        tr("着陆点 (LandingSite)"),     this, &UiSequenceWorkbench::onAddLandingSite);
...
void UiSequenceWorkbench::setupConnections()
{
    // 树选中 → 编辑器切换
    connect(commandTree_, &UiCommandTree::commandSelected,
            this, &UiSequenceWorkbench::onCommandSelected);
    ...
    connect(deleteAction_, &QAction::triggered,
            this, &UiSequenceWorkbench::onDeleteSegment);
    connect(openAction_, &QAction::triggered,
            this, &UiSequenceWorkbench::onOpenFile);
    connect(saveAction_, &QAction::triggered,
            this, &UiSequenceWorkbench::onSaveFile);
    connect(runAction_, &QAction::triggered,
            this, &UiSequenceWorkbench::onRun);
    connect(stopAction_, &QAction::triggered,
            this, &UiSequenceWorkbench::onStop);
}
...
void UiSequenceWorkbench::setSequence(MainSequence* sequence)
{
    setObject(sequence);
...
MainSequence* UiSequenceWorkbench::sequence() const
{
...
void UiSequenceWorkbench::onCommandSelected(Command* cmd)
{
...
void UiSequenceWorkbench::onAddInitialState()
{
...
void UiSequenceWorkbench::onAddPropagate()
{
    auto sequence = this->sequence();
    if (!sequence)
    {
...
void UiSequenceWorkbench::onAddManeuver()
{
    auto sequence = this->sequence();   
    if (!sequence)
    {
...
void UiSequenceWorkbench::onAddSequence()
{
    auto sequence = this->sequence();
    if (!sequence)
    {
...
void UiSequenceWorkbench::onAddTargeterSequence()
{
    auto sequence = this->sequence();
    if (!sequence)
    {
...
void UiSequenceWorkbench::onAddLandingSite()
{
    auto sequence = this->sequence();
    if (!sequence)
    {
...
void UiSequenceWorkbench::onDeleteSegment()
{
...
void UiSequenceWorkbench::onOpenFile()
{
...
void UiSequenceWorkbench::onSaveFile()
{
    auto sequence = this->sequence();
    if (!sequence)
    {
...
void UiSequenceWorkbench::onRun()
{
