...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">#include</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> &quot;ast/Vector.hpp&quot;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">#include</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> &lt;iostream&gt;</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">int</span><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;"> main</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">() {</span></span>
...
<span class="line"><span>/// @details   提供各种轨道根数（直角坐标、经典轨道根数、修正轨道根数、春分点根数、改进春分点轨道根数、球坐标根数、B平面根数）之间的转换函数。</span></span>
...
<span class="line"><span>#include &quot;AstUtil/Constants.hpp&quot;</span></span>
<span class="line"><span>#include &lt;string&gt;</span></span>
<span class="line"><span>#include &lt;cmath&gt;                // for std::isfinite</span></span>
<span class="line"><span> </span></span>
...
<span class="line"><span>/// @note  该类保持聚合类型, 不额外定义构造函数。</span></span>
<span class="line"><span>///        GCC 会对 CartState 的隐式默认构造函数报-Weffc++ 警告, 因此在类定义处局部抑制该警告。</span></span>
<span class="line"><span>#if defined(A_GCC) || defined(A_CLANG)</span></span>
<span class="line"><span>#   pragma GCC diagnostic push</span></span>
<span class="line"><span>#   pragma GCC diagnostic ignored &quot;-Weffc++&quot;</span></span>
...
<span class="line"><span>    const Vector3d&amp; position() const {return pos_;} </span></span>
<span class="line"><span>    Vector3d&amp; position() {return pos_;}</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    const Vector3d&amp; velocity() const {return vel_;} </span></span>
<span class="line"><span>    Vector3d&amp; velocity() {return vel_;}</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 判断状态分量是否全部为有限值</span></span>
<span class="line"><span>    bool isFinite() const{</span></span>
<span class="line"><span>        for (auto val: *this)</span></span>
<span class="line"><span>            if (!std::isfinite(val))</span></span>
<span class="line"><span>                return false;</span></span>
<span class="line"><span>        return true;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>};</span></span>
<span class="line"><span>#if defined(A_GCC) || defined(A_CLANG)</span></span>
<span class="line"><span>#   pragma GCC diagnostic pop</span></span>
<span class="line"><span>#endif</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>{</span></span>
<span class="line"><span>// 设置为public使类型为聚合类型</span></span>
<span class="line"><span>public:</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 计算近拱点经度</span></span>
<span class="line"><span>    double getLongitudeOfPeri() const {return aArgPeriToLongPeri(getArgPeri(), getRAAN());}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 计算平均经度</span></span>
<span class="line"><span>    double getMeanLongitude() const {return getLongitudeOfPeri() + getMeanAnomaly();}</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>// 设置为public使类型为聚合类型</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    double a_;          ///&lt; semimajor axis length (半长轴)</span></span>
...
<span class="line"><span>    double lambda_;     ///&lt; mean longitude = M + RAAN + argper (平经度)</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 平经度</span></span>
<span class="line"><span>    double meanLongitude() const {return lambda_;}</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    A_DEF_POD_ITERABLE(double)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, a)</span></span>
...
<span class="line"><span>    double L_;        ///&lt; L = RAAN + argper + trueA (真经度)</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 真经度</span></span>
<span class="line"><span>    double trueLongitude() const {return L_;}</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    A_DEF_POD_ITERABLE(double)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, p)</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief B平面根数</span></span>
<span class="line"><span>/// @details</span></span>
<span class="line"><span>/// B平面主要用于描述双曲线到达轨迹(月球或行星借力飞越)相对中心天体的状态。</span></span>
<span class="line"><span>/// B平面是垂直于入渐近线方向的平面, 位于该平面内的B矢量给出入渐近线与B平面的交点,</span></span>
<span class="line"><span>/// B矢量通常以平面内另外两个矢量R、T的分量表示。</span></span>
<span class="line"><span>/// 其中R、T由参考向量N决定: T = S x N, R = S x T (S为入渐近线方向)</span></span>
<span class="line"><span>/// @note  当偏心率e小于1(椭圆轨道)时, 入渐近线不存在, 给出退化结果, 参见 aCartToBPlane 的说明。</span></span>
<span class="line"><span>class BPlaneElem</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>// 设置为public使类型为聚合类型</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    double ra_;         ///&lt; 入渐近线赤经(B平面法向量的赤经) [rad]</span></span>
<span class="line"><span>    double dec_;        ///&lt; 入渐近线赤纬(B平面法向量的赤纬) [rad]</span></span>
<span class="line"><span>    double bDotR_;      ///&lt; B矢量在R轴上的分量 B·R [m]</span></span>
<span class="line"><span>    double bDotT_;      ///&lt; B矢量在T轴上的分量 B·T [m]</span></span>
<span class="line"><span>    double c3_;         ///&lt; 特征能量 C3 = v^2 - 2*gm/r [m^2/s^2]</span></span>
<span class="line"><span>    double trueA_;      ///&lt; 真近点角 [rad]</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 转换为字符串</span></span>
<span class="line"><span>    AST_CORE_API</span></span>
<span class="line"><span>    std::string toString() const;</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    A_DEF_POD_ITERABLE(double)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, ra)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, dec)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, bDotR)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, bDotT)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, c3)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, trueA)</span></span>
<span class="line"><span>};</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 球坐标轨道根数</span></span>
<span class="line"><span>/// @details</span></span>
<span class="line"><span>/// 用赤经、赤纬、地心距描述位置, 用飞行航迹角、航迹方位角、速度大小描述速度。</span></span>
<span class="line"><span>/// 各分量均在参考坐标系的轴系下定义:</span></span>
<span class="line"><span>///     ra  = atan2(y, x)           [rad] 赤经, 自x轴逆时针量</span></span>
<span class="line"><span>///     dec = atan2(z, hypot(x, y)) [rad] 赤纬, 范围[-π/2, π/2]</span></span>
<span class="line"><span>///     r   = |pos|                 [m]   地心距</span></span>
<span class="line"><span>///     fpa = atan2(v_r, v_h)       [rad] 航迹角, 速度矢量与当地水平面的夹角, 向上为正</span></span>
<span class="line"><span>///     azi = atan2(v_e, v_n)       [rad] 航迹方位角, 自当地北向东为正</span></span>
<span class="line"><span>///     v   = |vel|                 [m/s] 速度大小</span></span>
<span class="line"><span>/// @note  极点(|dec|=π/2)处赤经与航迹方位角奇异: 正向转换取ra=0, 仍保持精确往返;</span></span>
<span class="line"><span>///        零速度时航迹角与航迹方位角无定义, 正向转换失败。</span></span>
<span class="line"><span>class SphericalElem</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>// 设置为public使类型为聚合类型</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    double ra_;         ///&lt; 赤经 [rad]</span></span>
<span class="line"><span>    double dec_;        ///&lt; 赤纬 [rad]</span></span>
<span class="line"><span>    double r_;          ///&lt; 地心距 [m]</span></span>
<span class="line"><span>    double fpa_;        ///&lt; 航迹角 [rad]</span></span>
<span class="line"><span>    double azi_;        ///&lt; 航迹方位角 [rad]</span></span>
<span class="line"><span>    double v_;          ///&lt; 速度大小 [m/s]</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 获取赤经</span></span>
<span class="line"><span>    double getRA() const {return ra_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取赤纬</span></span>
<span class="line"><span>    double getDec() const {return dec_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取地心距</span></span>
<span class="line"><span>    double getRadius() const {return r_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取飞行航迹角(水平飞行航迹角)</span></span>
<span class="line"><span>    double getFltPathAng() const {return fpa_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取航迹方位角</span></span>
<span class="line"><span>    double getFltPathAzi() const {return azi_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取速度大小</span></span>
<span class="line"><span>    double getVel() const {return v_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 转换为字符串</span></span>
<span class="line"><span>    AST_CORE_API</span></span>
<span class="line"><span>    std::string toString() const;</span></span>
...
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, ra)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, dec)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, r)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, fpa)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, azi)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, v)</span></span>
<span class="line"><span>};</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 混合球坐标轨道根数</span></span>
<span class="line"><span>/// @details</span></span>
<span class="line"><span>/// 位置用天体固连系下的大地坐标描述, 速度由惯性速度矢量描述:</span></span>
<span class="line"><span>///     lon = atan2(y, x)           [rad] 大地经度(天体固连系), 自本初子午线向东为正</span></span>
<span class="line"><span>///     lat = 大地纬度               [rad] 椭球法线与赤道面的夹角, 范围[-π/2, π/2]</span></span>
<span class="line"><span>///     alt = 高度                   [m]   在参考椭球之上为正, 沿椭球法线量</span></span>
<span class="line"><span>///     fpa = atan2(v_r, v_h)       [rad] 水平航迹角, 惯性速度矢量与当地水平面的夹角, 向上为正</span></span>
<span class="line"><span>///     azi = atan2(v_e, v_n)       [rad] 航迹方位角, 自当地北向东为正</span></span>
<span class="line"><span>///     v   = |vel|                 [m/s] 惯性速度大小</span></span>
<span class="line"><span>/// @note  位置分量由固连系下的大地坐标给出, 需要参考形状(椭球, 见 @ref BodyShape)与固连系/惯性系之间的旋转(见 @ref Rotation);</span></span>
<span class="line"><span>///        速度分量则完全在参考系(惯性系)下定义, 与椭球和固连系无关, </span></span>
<span class="line"><span>///        当地水平面与当地北向由位置矢量在该系下的赤经确定(同 @ref SphericalElem), 不含固连系的牵连速度, 故 v 为惯性速度大小。</span></span>
<span class="line"><span>///        参见 @ref aCartToMixedSpherical 和 @ref aMixedSphericalToCart</span></span>
<span class="line"><span>class MixedSphericalElem</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>// 设置为public使类型为聚合类型</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    double lon_;        ///&lt; 大地经度 [rad] (天体固连系)</span></span>
<span class="line"><span>    double lat_;        ///&lt; 大地纬度 [rad] (天体固连系)</span></span>
<span class="line"><span>    double alt_;        ///&lt; 高度 [m] (相对参考椭球, 沿椭球法线)</span></span>
<span class="line"><span>    double fpa_;        ///&lt; 水平航迹角 [rad]</span></span>
<span class="line"><span>    double azi_;        ///&lt; 航迹方位角 [rad]</span></span>
<span class="line"><span>    double v_;          ///&lt; 惯性速度大小 [m/s]</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 获取大地经度</span></span>
<span class="line"><span>    double getLon() const {return lon_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取大地纬度</span></span>
<span class="line"><span>    double getLat() const {return lat_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取高度</span></span>
<span class="line"><span>    double getAlt() const {return alt_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取飞行航迹角(水平飞行航迹角)</span></span>
<span class="line"><span>    double getFltPathAng() const {return fpa_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取垂直飞行航迹角(水平飞行航迹角的余角)</span></span>
<span class="line"><span>    double getVertFltPathAng() const {return kHalfPI - fpa_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取航迹方位角</span></span>
<span class="line"><span>    double getFltPathAzi() const {return azi_;}</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>public:</span></span>
<span class="line"><span>    A_DEF_POD_ITERABLE(double)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, lon)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, lat)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, alt)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, fpa)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, azi)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, v)</span></span>
<span class="line"><span>};</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 大地坐标根数</span></span>
<span class="line"><span>/// @details</span></span>
<span class="line"><span>/// 位置与速度均在天体固连系下以大地坐标及其变化率描述:</span></span>
<span class="line"><span>///     lon = atan2(y, x)           [rad]   大地经度(天体固连系), 自本初子午线向东为正</span></span>
<span class="line"><span>///     lat                          [rad]   大地纬度, 椭球法线与赤道面的夹角, 范围[-π/2, π/2]</span></span>
<span class="line"><span>///     alt                          [m]     高度, 在参考椭球之上为正, 沿椭球法线量</span></span>
<span class="line"><span>///     lonRate                      [rad/s] 大地经度变化率</span></span>
<span class="line"><span>///     latRate                      [rad/s] 大地纬度变化率</span></span>
<span class="line"><span>///     altRate                      [m/s]   高度变化率</span></span>
<span class="line"><span>/// @note  与 @ref MixedSphericalElem 的关键区别在于速度也完全在固连系下定义:</span></span>
<span class="line"><span>///        vel = (N+alt)cos(lat)·lonRate·e + (M+alt)·latRate·n + altRate·u ,</span></span>
<span class="line"><span>///        其中 e、n、u 为当地东、北、天单位矢量, N、M 为卯酉圈与子午圈曲率半径。</span></span>
<span class="line"><span>///        因此 vel 为零(如地球同步轨道)时三个变化率亦为零, 与惯性速度无关。</span></span>
<span class="line"><span>///        需要参考形状(椭球, 见 @ref BodyShape)以及参考系与固连系之间的运动学变换(见 @ref KinematicTransform)。</span></span>
<span class="line"><span>///        极点(lat=±π/2)处经度率奇异, 正向转换取lonRate=0(约定), 与 @ref SphericalElem 的赤经一致。</span></span>
<span class="line"><span>///        参见 @ref aCartToGeodetic 和 @ref aGeodeticToCart</span></span>
<span class="line"><span>class GeodeticElem</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>// 设置为public使类型为聚合类型</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    double lat_;        ///&lt; 大地纬度 [rad] (天体固连系)</span></span>
<span class="line"><span>    double lon_;        ///&lt; 大地经度 [rad] (天体固连系)</span></span>
<span class="line"><span>    double alt_;        ///&lt; 高度 [m] (相对参考椭球, 沿椭球法线)</span></span>
<span class="line"><span>    double latRate_;    ///&lt; 大地纬度变化率 [rad/s] (天体固连系)</span></span>
<span class="line"><span>    double lonRate_;    ///&lt; 大地经度变化率 [rad/s] (天体固连系)</span></span>
<span class="line"><span>    double altRate_;    ///&lt; 高度变化率 [m/s] (天体固连系)</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 获取大地经度</span></span>
<span class="line"><span>    double getLon() const {return lon_;}</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    double getAlt() const {return alt_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取大地经度变化率</span></span>
<span class="line"><span>    double getLonRate() const {return lonRate_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取大地纬度变化率</span></span>
<span class="line"><span>    double getLatRate() const {return latRate_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取高度变化率</span></span>
<span class="line"><span>    double getAltRate() const {return altRate_;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 转换为字符串</span></span>
<span class="line"><span>    AST_CORE_API</span></span>
<span class="line"><span>    std::string toString() const;</span></span>
...
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, lat)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, alt)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, lonRate)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, latRate)</span></span>
<span class="line"><span>    AST_DEF_ACCESS_METHOD(double, altRate)</span></span>
<span class="line"><span>};</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 直角坐标转换为球坐标根数</span></span>
<span class="line"><span>/// @param pos 位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 速度矢量 [m/s]</span></span>
<span class="line"><span>/// @param sph 输出球坐标根数</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>/// @note  位置或速度为零矢量时无法确定赤经、赤纬、航迹角与航迹方位角, 返回eErrorInvalidParam</span></span>
<span class="line"><span>AST_CORE_API errc_t aCartToSpherical(</span></span>
<span class="line"><span>    const Vector3d&amp; pos,</span></span>
<span class="line"><span>    const Vector3d&amp; vel,</span></span>
<span class="line"><span>    SphericalElem&amp; sph</span></span>
<span class="line"><span>);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 球坐标根数转换为直角坐标</span></span>
<span class="line"><span>/// @param sph 球坐标根数</span></span>
<span class="line"><span>/// @param pos 输出位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 输出速度矢量 [m/s]</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>/// @note  地心距不大于零或速度小于零时返回eErrorInvalidParam</span></span>
<span class="line"><span>AST_CORE_API errc_t aSphericalToCart(</span></span>
<span class="line"><span>    const SphericalElem&amp; sph,</span></span>
<span class="line"><span>    Vector3d&amp; pos,</span></span>
<span class="line"><span>    Vector3d&amp; vel</span></span>
<span class="line"><span>);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 直角坐标转换为混合球坐标根数</span></span>
<span class="line"><span>/// @param pos 位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 速度矢量 [m/s]</span></span>
<span class="line"><span>/// @param framelToFixed 位置速度参考系到天体固连系的旋转, 仅用于位置分量</span></span>
<span class="line"><span>/// @param shape 参考形状(椭球), 仅用于位置分量</span></span>
<span class="line"><span>/// @param mixedSph 输出混合球坐标根数</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>/// @note  位置或速度为零矢量时无法确定经度、纬度、航迹角与航迹方位角, 返回eErrorInvalidParam;</span></span>
<span class="line"><span>///        航迹角与航迹方位角完全由 pos、vel 在惯性系下确定, 与 inertialToFixed、shape 无关,</span></span>
<span class="line"><span>///        见 @ref MixedSphericalElem。</span></span>
<span class="line"><span>AST_CORE_API errc_t aCartToMixedSpherical(</span></span>
<span class="line"><span>    const Vector3d&amp; pos,</span></span>
<span class="line"><span>    const Vector3d&amp; vel,</span></span>
<span class="line"><span>    const Rotation&amp; framelToFixed,</span></span>
<span class="line"><span>    const BodyShape&amp; shape,</span></span>
<span class="line"><span>    MixedSphericalElem&amp; mixedSph</span></span>
<span class="line"><span>);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 混合球坐标根数转换为直角坐标</span></span>
<span class="line"><span>/// @param mixedSph 混合球坐标根数</span></span>
<span class="line"><span>/// @param fixedToframe 天体固连系到参考系的旋转, 需与生成mixedSph时所用的旋转互逆, 仅用于位置分量</span></span>
<span class="line"><span>/// @param shape 参考形状(椭球), 仅用于位置分量</span></span>
<span class="line"><span>/// @param pos 输出位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 输出速度矢量 [m/s]</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>/// @note  速度小于零或位置退化到参考椭球中心时返回eErrorInvalidParam</span></span>
<span class="line"><span>AST_CORE_API errc_t aMixedSphericalToCart(</span></span>
<span class="line"><span>    const MixedSphericalElem&amp; mixedSph,</span></span>
<span class="line"><span>    const Rotation&amp; fixedToframe,</span></span>
<span class="line"><span>    const BodyShape&amp; shape,</span></span>
<span class="line"><span>    Vector3d&amp; pos,</span></span>
<span class="line"><span>    Vector3d&amp; vel</span></span>
<span class="line"><span>);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 天体固连系直角坐标转换为大地坐标根数</span></span>
<span class="line"><span>/// @param pos 天体固连系下的位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 天体固连系下的速度矢量 [m/s]</span></span>
<span class="line"><span>/// @param shape 参考形状(椭球)</span></span>
<span class="line"><span>/// @param geodetic 输出大地坐标根数</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>/// @note  与 @ref aCartToMixedSpherical 不同, 这里的 pos 与 vel 均为天体固连系下的量,</span></span>
<span class="line"><span>///        故不需要旋转参数; 参考系与固连系之间的换算由调用方(见 @ref StateGeodetic )负责。</span></span>
<span class="line"><span>///        位置或速度为零矢量时无法确定经度、纬度或变化率, 返回eErrorInvalidParam;</span></span>
<span class="line"><span>///        极点(lat=±π/2)处经度率奇异, 取lonRate=0(约定); 参考形状不支持该转换时透传其错误码。</span></span>
<span class="line"><span>AST_CORE_API errc_t aCartToGeodetic(</span></span>
<span class="line"><span>    const Vector3d&amp; pos,</span></span>
<span class="line"><span>    const Vector3d&amp; vel,</span></span>
<span class="line"><span>    const BodyShape&amp; shape,</span></span>
<span class="line"><span>    GeodeticElem&amp; geodetic</span></span>
<span class="line"><span>);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 大地坐标根数转换为天体固连系直角坐标</span></span>
<span class="line"><span>/// @param geodetic 大地坐标根数</span></span>
<span class="line"><span>/// @param shape 参考形状(椭球)</span></span>
<span class="line"><span>/// @param pos 输出天体固连系下的位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 输出天体固连系下的速度矢量 [m/s]</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>/// @note  速度为天体固连系下的速度, 不包含任何牵连速度;</span></span>
<span class="line"><span>///        大地纬度超出[-π/2, π/2]或位置退化到参考椭球中心附近时返回eErrorInvalidParam;</span></span>
<span class="line"><span>///        参考形状不支持该转换时透传其错误码。</span></span>
<span class="line"><span>AST_CORE_API errc_t aGeodeticToCart(</span></span>
<span class="line"><span>    const GeodeticElem&amp; geodetic,</span></span>
<span class="line"><span>    const BodyShape&amp; shape,</span></span>
<span class="line"><span>    Vector3d&amp; pos,</span></span>
<span class="line"><span>    Vector3d&amp; vel</span></span>
<span class="line"><span>);</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief B平面参考向量类型</span></span>
<span class="line"><span>/// @details B平面内的R、T两轴由参考向量N决定: T = unit(S x N), R = S x T,</span></span>
<span class="line"><span>///          其中S为入渐近线方向。不同的参考向量会给出不同的R、T轴。</span></span>
<span class="line"><span>enum class EBPlaneRefVector</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>    eBodyOrbitNormal,           ///&lt; 天体绕其父天体运动的轨道法向</span></span>
<span class="line"><span>    eSpacecraftOrbitNormal,     ///&lt; 航天器自身的轨道法向</span></span>
<span class="line"><span>    eBodyPole,                  ///&lt; 天体的自转轴</span></span>
<span class="line"><span>    eCustom,                    ///&lt; 自定义参考向量</span></span>
<span class="line"><span>};</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 直角坐标转换为B平面根数</span></span>
<span class="line"><span>/// @param pos 位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 速度矢量 [m/s]</span></span>
<span class="line"><span>/// @param gm 引力参数 [m^3/s^2]</span></span>
<span class="line"><span>/// @param refVector 参考向量(任意非零矢量), 用于确定R、T轴, 见 EBPlaneRefVector</span></span>
<span class="line"><span>/// @param bPlane 输出B平面根数</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>/// @note  当偏心率e大于1时, 按B平面的定义计算;</span></span>
<span class="line"><span>///        e不大于1时入渐近线不存在, 此时退化处理:</span></span>
<span class="line"><span>///        |B|取椭圆半短轴 a*sqrt(1-e^2), 入渐近线方向S取偏心率向量方向,</span></span>
<span class="line"><span>///        偏心率向量为零(圆轨道)时取坐标系的+X轴。</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aCartToBPlane(</span></span>
<span class="line"><span>    const Vector3d&amp; pos,</span></span>
<span class="line"><span>    const Vector3d&amp; vel,</span></span>
<span class="line"><span>    double gm,</span></span>
<span class="line"><span>    const Vector3d&amp; refVector,</span></span>
<span class="line"><span>    BPlaneElem&amp; bPlane</span></span>
<span class="line"><span>);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief B平面根数转换为直角坐标</span></span>
<span class="line"><span>/// @param bPlane B平面根数</span></span>
<span class="line"><span>/// @param gm 引力参数 [m^3/s^2]</span></span>
<span class="line"><span>/// @param refVector 参考向量(任意非零矢量), 需与生成bPlane时一致</span></span>
<span class="line"><span>/// @param pos 输出位置矢量 [m]</span></span>
<span class="line"><span>/// @param vel 输出速度矢量 [m/s]</span></span>
<span class="line"><span>/// @return 错误码，成功返回eNoError</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aBPlaneToCart(</span></span>
<span class="line"><span>    const BPlaneElem&amp; bPlane,</span></span>
<span class="line"><span>    double gm,</span></span>
<span class="line"><span>    const Vector3d&amp; refVector,</span></span>
<span class="line"><span>    Vector3d&amp; pos,</span></span>
<span class="line"><span>    Vector3d&amp; vel</span></span>
...
<span class="line"><span> </span></span>
<span class="line"><span>AST_DECL_TYPE_ALIAS(CartState)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23)])])}const v=n(p,[["render",e]]),t=JSON.parse('{"path":"/technical/core/orbit-element.html","title":"轨道根数定义及转换","lang":"zh-CN","frontmatter":{"description":"轨道根数定义及转换 说明：本文档旨在帮助理解模块功能，具体API和行为请查阅源代码。 模块概述 OrbitElement模块提供各种轨道根数（直角坐标、经典轨道根数、修正轨道根数、春分点根数、改进春分点轨道根数）之间的转换函数，是天体力学和航天动力学计算的基础组件。 核心概念 轨道根数类型 模块定义了以下主要轨道根数类型： 直角坐标系 (CartSta...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"轨道根数定义及转换\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-13T12:14:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"space-ast\\",\\"url\\":\\"https://github.com/space-ast\\"}]}"],["meta",{"property":"og:url","content":"https://github.com/space-ast/ast/ast/technical/core/orbit-element.html"}],["meta",{"property":"og:site_name","content":"🛰️航天仿真算法库文档"}],["meta",{"property":"og:title","content":"轨道根数定义及转换"}],["meta",{"property":"og:description","content":"轨道根数定义及转换 说明：本文档旨在帮助理解模块功能，具体API和行为请查阅源代码。 模块概述 OrbitElement模块提供各种轨道根数（直角坐标、经典轨道根数、修正轨道根数、春分点根数、改进春分点轨道根数）之间的转换函数，是天体力学和航天动力学计算的基础组件。 核心概念 轨道根数类型 模块定义了以下主要轨道根数类型： 直角坐标系 (CartSta..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-05-13T12:14:10.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-13T12:14:10.000Z"}]]},"git":{"createdTime":1778649958000,"updatedTime":1778674450000,"contributors":[{"name":"axel","username":"axel","email":"space_ast@163.com","commits":2,"url":"https://github.com/axel"}]},"readingTime":{"minutes":1.84,"words":552},"filePathRelative":"technical/core/orbit-element.md","autoDesc":true}');export{v as comp,t as data};
