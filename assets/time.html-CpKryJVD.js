...
<span class="line"><span>*/</span></span>
<span class="line"><span></span></span>
<span class="line"><span>constexpr int kTimeDefaultFormatPrecision = 3;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param dttm </span></span>
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @param precision 时间精度</span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatGregorian(const DateTime&amp; dttm, std::string&amp; str, int precision = kTimeDefaultFormatPrecision);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param precision 时间精度</span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatGregorianEn(const DateTime&amp; dttm, std::string&amp; str, int precision = kTimeDefaultFormatPrecision);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    double secOfDay() const {return time_.totalSecond();}</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 将不精确的儒略日 Julian Date（MJD）转换为不精确的简约儒略日</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 将儒略日转换为不精确的简约儒略日</span></span>
<span class="line"><span>/// @warning 注意用单个double表示的时间精度不高</span></span>
<span class="line"><span>AST_CORE_API ImpreciseMJD aJDToMJD_Imprecise(const JulianDate&amp; jd);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 将不精确的简约儒略日Modified Julian Date（MJD）转换为不精确的儒略日</span></span>
<span class="line"><span>/// @warning 注意用单个double表示的时间精度不高</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 将不精确的简约儒略日Modified Julian Date（MJD）转换为儒略日</span></span>
<span class="line"><span>AST_CORE_API void aMJDToJD_Imprecise(ImpreciseMJD mjd, JulianDate&amp; jd);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// 在 JulianDate 类的实现中，将儒略日表示为整数天 + 小数秒的形式，保证数值精度</span></span>
<span class="line"><span>class JulianDate</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 根据不精确的天数创建儒略日</span></span>
<span class="line"><span>    /// @param day 天数 [day] (单个double表示的天数精度不高)</span></span>
<span class="line"><span>    static JulianDate FromImpreciseDay(double day){</span></span>
<span class="line"><span>        int d = static_cast&lt;int&gt;(day);</span></span>
<span class="line"><span>        double second = (day - d) * 86400.0;</span></span>
<span class="line"><span>        return JulianDate::FromDaySecond(d, second);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 根据天数(分两部分)创建儒略日</span></span>
<span class="line"><span>    /// @param day1 天数第1部分 [day]</span></span>
<span class="line"><span>    /// @param day2 天数第2部分 [day]</span></span>
<span class="line"><span>    static JulianDate FromDays(double day1, double day2)</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>        int d1 = static_cast&lt;int&gt;(day1);</span></span>
<span class="line"><span>        int d2 = static_cast&lt;int&gt;(day2);</span></span>
<span class="line"><span>        double second = ((day1 - d1) + (day2 - d2)) * 86400.0;</span></span>
<span class="line"><span>        return JulianDate::FromDaySecond(d1 + d2, second);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 根据天数和秒数创建儒略日</span></span>
<span class="line"><span>    /// @param day 天数 [day]</span></span>
<span class="line"><span>    /// @param second 秒数 [second]</span></span>
...
<span class="line"><span>    /// @param day 天数 [day] </span></span>
<span class="line"><span>    /// @param second 秒数 [second]</span></span>
<span class="line"><span>    static JulianDate FromDaySecond(double day, double second)</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>        int d = static_cast&lt;int&gt;(day);</span></span>
<span class="line"><span>        double s = (day - d) * 86400.0;</span></span>
<span class="line"><span>        return JulianDate{d, second + s};</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 根据日期时间创建儒略日</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 获取 J2000.0 历元的儒略日</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>    /// @brief 计算儒略日与 J2000.0 历元的天数差</span></span>
<span class="line"><span>    double daysFromJ2000() const{</span></span>
<span class="line"><span>        return daysFromJulianDate(kJ2000Epoch);</span></span>
<span class="line"><span>    }</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>    /// @brief 计算儒略日与另一个儒略日的天数差</span></span>
<span class="line"><span>    double daysFromJulianDate(double jd) const</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>        return ((day_ - jd) + dayFractional());</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    /// @brief 计算儒略日与另一个儒略日的时间差（秒）</span></span>
<span class="line"><span>    double secondsFromJulianDate(double jd) const</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>        return (day_ - jd) * kSecondsPerDay + second_;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    </span></span>
<span class="line"><span>    double daysFrom(const JulianDate&amp; other) const{</span></span>
<span class="line"><span>        return (*this - other).totalDay();</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>public:</span></span>
...
<span class="line"><span>    double totalSecond() const{return (integer_ + fractional_);}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 转换为秒数</span></span>
<span class="line"><span>    /// @return 总秒数（整数天秒数 + 小数秒数）</span></span>
<span class="line"><span>    operator double() const{return totalSecond();}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>public:</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>    /// @warning </span></span>
<span class="line"><span>    /// 注意：totalDay() 方法返回的是一个不精确的double值，</span></span>
<span class="line"><span>    /// 计算会引入舍入误差。且不考虑闰秒等因素。</span></span>
<span class="line"><span>    /// @return 总天数（整数天部分 + 小数部分）</span></span>
<span class="line"><span>    double totalDay() const{return day_ + second_ / 86400.0;}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 转换为秒数</span></span>
<span class="line"><span>    /// @return 总秒数（整数天秒数 + 小数秒数）</span></span>
<span class="line"><span>    operator double() const{return totalSecond();}</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>AST_NAMESPACE_END</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,30)])])}const r=n(p,[["render",e]]),v=JSON.parse('{"path":"/technical/core/time.html","title":"时间模块","lang":"zh-CN","frontmatter":{"description":"时间模块 说明：本文档旨在帮助理解模块功能，具体API和行为请查阅源代码。 模块概述 Time模块提供了全面的时间处理功能，包括日期、时间、日期时间、儒略日、简约儒略日、时长以及时间系统转换等功能。该模块是天体力学和航天动力学计算的基础组件，支持各种时间表示形式之间的转换和操作。 核心概念 时间表示类型 模块定义了以下主要时间表示类型： Date (日...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"时间模块\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-13T12:14:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"space-ast\\",\\"url\\":\\"https://github.com/space-ast\\"}]}"],["meta",{"property":"og:url","content":"https://github.com/space-ast/ast/ast/technical/core/time.html"}],["meta",{"property":"og:site_name","content":"🛰️航天仿真算法库文档"}],["meta",{"property":"og:title","content":"时间模块"}],["meta",{"property":"og:description","content":"时间模块 说明：本文档旨在帮助理解模块功能，具体API和行为请查阅源代码。 模块概述 Time模块提供了全面的时间处理功能，包括日期、时间、日期时间、儒略日、简约儒略日、时长以及时间系统转换等功能。该模块是天体力学和航天动力学计算的基础组件，支持各种时间表示形式之间的转换和操作。 核心概念 时间表示类型 模块定义了以下主要时间表示类型： Date (日..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-05-13T12:14:10.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-13T12:14:10.000Z"}]]},"git":{"createdTime":1778649958000,"updatedTime":1778674450000,"contributors":[{"name":"axel","username":"axel","email":"space_ast@163.com","commits":2,"url":"https://github.com/axel"}]},"readingTime":{"minutes":2.13,"words":639},"filePathRelative":"technical/core/time.md","autoDesc":true}');export{r as comp,v as data};
